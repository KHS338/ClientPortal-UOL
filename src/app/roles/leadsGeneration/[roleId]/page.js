...
export default function LeadGenerationDetailPage() {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-lg">Loading lead generation details...</div>
      </div>
    );
  }
      ...
      <div className="mb-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">
            Lead Generation Details: {role?.industryType}
          </h1>
      ...
      <div className="bg-white rounded-lg shadow-md">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">
            Generated Leads ({results.length})
          </h2>
        </div>
        
        {results.length === 0 ? (
          <div className="p-6 text-center text-gray-500">
            No leads generated for this campaign yet.
          </div>
        ) : (
